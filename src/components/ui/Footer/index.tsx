...
import { LogoFull } from '/Users/macbook/dzengi/public/assets/img';
    ...
    return (
        <footer className={classes.footer}>
            ...
            <Container className={classes.afterFooter}>
                ...
                <Group className={classes.social} align="flex-end" >
                    <ActionIcon size="lg" color="gray" variant="subtle">
                        <Twitter style={{ width: rem(18), height: rem(18) }} stroke={'1.5'} />
                    </ActionIcon>
                    <ActionIcon size="lg" color="gray" variant="subtle">
                        <Youtube style={{ width: rem(18), height: rem(18) }} stroke={'1.5'} />
                    </ActionIcon>
                    <ActionIcon size="lg" color="gray" variant="subtle">
                        <Instagram style={{ width: rem(18), height: rem(18) }} stroke={'1.5'} />
                    </ActionIcon>
                </Group>
            </Container>
        </footer>
